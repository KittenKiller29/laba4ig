...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("C:/Users/azamat/Desktop/box.obj")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/Users/azamat/Desktop/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/azamat/Desktop/normal_map.jpg");

        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/azamat/Desktop/normal_up.jpg");
