...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("C:/Users/azamat/Desktop/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/Users/azamat/Desktop/test.png");
        ...
        return m_pMesh->LoadMesh("C:/Users/azamat/Desktop/phoenix_ugv.md2");
    }
